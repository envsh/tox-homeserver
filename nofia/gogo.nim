...
let usewhich = "cxrtgo" # "gocrt", "libgo"
# include "cxrtgoimpl.nim"
# proc goroutine_post(f:pointer, arg:pointer) =
#     cxrt_routine_post(f, arg)

# include "libgoimpl.nim"
# proc goroutine_post(f:pointer, arg:pointer) =
#     discard

include "gocrt.nim"
proc goroutine_post(f:pointer, arg:pointer) = gogoimp(f, arg)
...
macro gogo(stmt : untyped) : untyped =
    ...
    retstmt.add(newCall(ident("goroutine_post"), ident("fnptr"), ident("fnargptr2")))
