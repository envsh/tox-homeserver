...
func (this *Ui_MainWindow) SetupUi(MainWindow *qtwidgets.QMainWindow) {
	...
	this.VerticalLayout_13 = qtwidgets.NewQVBoxLayout_1(qtwidgets.NewQWidgetFromPointer(this.Page_4.GetCthis())) // 111
	...
	this.VerticalLayout_13.Layout().AddWidget(qtwidgets.NewQWidgetFromPointer(this.QuickWidget_2.GetCthis())) // 115

	this.StackedWidget.AddWidget(qtwidgets.NewQWidgetFromPointer(this.Page_4.GetCthis()))                        // 115
	...
	this.VerticalLayout_11.Layout().AddWidget(qtwidgets.NewQWidgetFromPointer(this.QuickWidget.GetCthis())) // 115
	...
	this.ScrollAreaWidgetContents_2.SetGeometry(0, 0, 380, 222)                                                                     // 114
	...
	this.ScrollAreaWidgetContents.SetGeometry(0, 0, 380, 222)                                                                     // 114
