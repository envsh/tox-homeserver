...
func (this *Ui_MainWindow) SetupUi(MainWindow *qtwidgets.QMainWindow) {
	...
	this.HorizontalLayout_7.SetObjectName(qtcore.NewQString_5("HorizontalLayout_7"))                                   // 112
	this.ToolButton_11 = qtwidgets.NewQToolButton(this.Centralwidget)                                                  // 111
	this.ToolButton_11.SetObjectName(qtcore.NewQString_5("ToolButton_11"))                                             // 112
	this.ToolButton_11.SetFocusPolicy(qtcore.Qt__NoFocus)                                                              // 114
	this.Icon = qtgui.NewQIcon()
	this.Icon.AddFile(qtcore.NewQString_5(":/icons/barbuttonicon_back_gray64.png"), qtcore.NewQSize(), qtgui.QIcon__Normal, qtgui.QIcon__Off) // 115
	this.ToolButton_11.SetIcon(this.Icon)                                                                                                     // 114

	this.HorizontalLayout_7.Layout().AddWidget(qtwidgets.NewQWidgetFromPointer(this.ToolButton_11.GetCthis())) // 115
	...
	this.HorizontalLayout_7.Layout().AddWidget(qtwidgets.NewQWidgetFromPointer(this.Label.GetCthis())) // 115

	this.ToolButton_12 = qtwidgets.NewQToolButton(this.Centralwidget)      // 111
	this.ToolButton_12.SetObjectName(qtcore.NewQString_5("ToolButton_12")) // 112
	this.ToolButton_12.SetFocusPolicy(qtcore.Qt__NoFocus)                  // 114
	this.Icon1 = qtgui.NewQIcon()
	this.Icon1.AddFile(qtcore.NewQString_5(":/icons/barbuttonicon_forward_gray64.png"), qtcore.NewQSize(), qtgui.QIcon__Normal, qtgui.QIcon__Off) // 115
	this.ToolButton_12.SetIcon(this.Icon1)                                                                                                        // 114

	this.HorizontalLayout_7.Layout().AddWidget(qtwidgets.NewQWidgetFromPointer(this.ToolButton_12.GetCthis())) // 115

	this.VerticalLayout_6.AddLayout(qtwidgets.NewQLayoutFromPointer(this.HorizontalLayout_7.GetCthis()), 0) // 115

	this.StackedWidget = qtwidgets.NewQStackedWidget(this.Centralwidget)                                         // 111
	this.StackedWidget.SetObjectName(qtcore.NewQString_5("StackedWidget"))                                       // 112
	this.Page_3 = qtwidgets.NewQWidget(nil, 0)                                                                   // 111
	this.Page_3.SetObjectName(qtcore.NewQString_5("Page_3"))                                                     // 112
	this.VerticalLayout_11 = qtwidgets.NewQVBoxLayout_1(qtwidgets.NewQWidgetFromPointer(this.Page_3.GetCthis())) // 111
	...
	this.StackedWidget.AddWidget(qtwidgets.NewQWidgetFromPointer(this.Page_3.GetCthis()))                     // 115
	this.Page = qtwidgets.NewQWidget(nil, 0)                                                                  // 111
	this.Page.SetObjectName(qtcore.NewQString_5("Page"))                                                      // 112
	this.VerticalLayout_5 = qtwidgets.NewQVBoxLayout_1(qtwidgets.NewQWidgetFromPointer(this.Page.GetCthis())) // 111
	...
	this.Icon2.AddFile(qtcore.NewQString_5(":/icons/icon_avatar_40.png"), qtcore.NewQSize(), qtgui.QIcon__Normal, qtgui.QIcon__Off) // 115
	...
	this.Icon3.AddFile(qtcore.NewQString_5(":/icons/online_30.png"), qtcore.NewQSize(), qtgui.QIcon__Normal, qtgui.QIcon__Off) // 115
	...
	this.VerticalLayout_5.AddLayout(qtwidgets.NewQLayoutFromPointer(this.HorizontalLayout.GetCthis()), 0) // 115
	...
	this.Icon4.AddFile(qtcore.NewQString_5(":/icons/remove-symbol_gray64.png"), qtcore.NewQSize(), qtgui.QIcon__Normal, qtgui.QIcon__Off) // 115
	...
	this.VerticalLayout_5.AddLayout(qtwidgets.NewQLayoutFromPointer(this.HorizontalLayout_2.GetCthis()), 0) // 115
	...
	this.VerticalLayout_5.Layout().AddWidget(qtwidgets.NewQWidgetFromPointer(this.ListWidget_2.GetCthis())) // 115
	...
	this.VerticalLayout_5.AddLayout(qtwidgets.NewQLayoutFromPointer(this.HorizontalLayout_3.GetCthis()), 0) // 115

	this.StackedWidget.AddWidget(qtwidgets.NewQWidgetFromPointer(this.Page.GetCthis()))                          // 115
	this.Page_2 = qtwidgets.NewQWidget(nil, 0)                                                                   // 111
	this.Page_2.SetObjectName(qtcore.NewQString_5("Page_2"))                                                     // 112
	this.VerticalLayout_2 = qtwidgets.NewQVBoxLayout_1(qtwidgets.NewQWidgetFromPointer(this.Page_2.GetCthis()))  // 111
	...
	this.Icon9.AddFile(qtcore.NewQString_5(":/icons/phone_mic_gray64.png"), qtcore.NewQSize(), qtgui.QIcon__Normal, qtgui.QIcon__Off) // 115
	...
	this.Icon10.AddFile(qtcore.NewQString_5(":/icons/speaker_volume_gray64.png"), qtcore.NewQSize(), qtgui.QIcon__Normal, qtgui.QIcon__Off) // 115
	...
	this.Icon11.AddFile(qtcore.NewQString_5(":/icons/phone_call_gray64.png"), qtcore.NewQSize(), qtgui.QIcon__Normal, qtgui.QIcon__Off) // 115
	...
	this.Icon12.AddFile(qtcore.NewQString_5(":/icons/video_recorder_gray64.png"), qtcore.NewQSize(), qtgui.QIcon__Normal, qtgui.QIcon__Off) // 115
	...
	this.VerticalLayout_2.AddLayout(qtwidgets.NewQLayoutFromPointer(this.HorizontalLayout_5.GetCthis()), 0) // 115
	...
	this.VerticalLayout_2.Layout().AddWidget(qtwidgets.NewQWidgetFromPointer(this.ScrollArea_2.GetCthis())) // 115
	...
	this.VerticalLayout_2.AddLayout(qtwidgets.NewQLayoutFromPointer(this.HorizontalLayout_6.GetCthis()), 0) // 115

	this.StackedWidget.AddWidget(qtwidgets.NewQWidgetFromPointer(this.Page_2.GetCthis())) // 115

	this.VerticalLayout_6.Layout().AddWidget(qtwidgets.NewQWidgetFromPointer(this.StackedWidget.GetCthis())) // 115

	this.MainWindow.SetCentralWidget(this.Centralwidget) // 114

	this.RetranslateUi(MainWindow)

	this.StackedWidget.SetCurrentIndex(1) // 114
